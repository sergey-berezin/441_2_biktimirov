...
namespace YOLOlib
{
    ...
    public class Detector
    {
        ...
        public Detector(IFileServices fs)
        {
            fileServices = fs;
            string neuralNetName = "tinyyolov2-8.onnx";
            if (!fileServices.Exists(neuralNetName))
                fileServices.Download("https://storage.yandexcloud.net/dotnet4/tinyyolov2-8.onnx", neuralNetName);
